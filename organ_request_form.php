...
<head>
    ...
    <title>Life Line | Organ Request Form </title>
...
<style>
    *{
    ...
    .btn{
        background-color: rgb(230,84,127);
        outline: none;
        color: white;
    }
    .btn:hover{
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top pl-5">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown mt-1 active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item active" href="organ_request_form.php" target="_blank">Request Organs</a>
                    <div class="dropdown-divider"></div>
    ...
    <div class="container mt-5 ">
      <div class="row justify-content-center">
        ...
        <div class="col-md-6 mt-5">
          <img src="./assets/images/helping hand.jpeg "   class="image-responsive" height="100%" width="100%"
          alt="">
    ...
    <form action=”<?php echo htmlspecialchars($_SERVER[‘PHP_SELF’]); ?>” method="post"  >
        ...
        <div class="form-group">
          <label for="organ"><b>Organ Required:</b></label>
          <input type="text" class="form-control" id="organ" placeholder="Enter organ needed" name="organ" required>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="loc" placeholder="Eg: Kottayam, Kerala" name="location" required>
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback">Please fill out this field.</div>
          </div>
        </div>
        ...
        <div class="form-group form-check">
          <label class="form-check-label">
            <input class="form-check-input" type="checkbox" name="remember" required> I  agree on <a href="terms.php">  terms and conditions.</a>
            <div class="valid-feedback">Valid.</div>
